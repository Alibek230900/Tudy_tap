...
import com.example.flag.R.drawable
import com.example.flag.R.drawable.default_option_border_bg
...
class QuizQuestionsActivity : AppCompatActivity(), View.OnClickListener{
    ...
    private fun setQuestion(){
        ...
        if (mCurrentPosition==mQuestionList!!.size){
            btn_submit.text="Аяқтау"
        } else{
            btn_submit.text="Растау"
        }
    ...
    private fun defaultOptionsView(){
        ...
        for (option in options){
            option.setTextColor(Color.parseColor("#FFFF00"))
